...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#country_places" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="country_places">
            @includeIf('admin.countries.relationships.countryPlaces', ['places' => $country->countryPlaces])
        </div>
    </div>
</div>

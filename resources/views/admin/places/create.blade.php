    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.places.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('brief') ? 'is-invalid' : '' }}" type="text" name="brief" id="brief" value="{{ old('brief', '') }}">
                @if($errors->has('brief'))
                    <div class="invalid-feedback">
                        {{ $errors->first('brief') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vimeo_url') ? 'is-invalid' : '' }}" type="text" name="vimeo_url" id="vimeo_url" value="{{ old('vimeo_url', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('latest_place') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="latest_place" id="latest_place" value="1" {{ old('latest_place', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('popular_place') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="popular_place" id="popular_place" value="1" {{ old('popular_place', 0) == 1 ? 'checked' : '' }}>

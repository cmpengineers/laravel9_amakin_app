...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.itemReview.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.item-reviews.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="quality">{{ trans('cruds.itemReview.fields.quality') }}</label>
                <input class="form-control {{ $errors->has('quality') ? 'is-invalid' : '' }}" type="number" name="quality" id="quality" value="{{ old('quality', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="number" name="location" id="location" value="{{ old('location', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wifi') ? 'is-invalid' : '' }}" type="number" name="wifi" id="wifi" value="{{ old('wifi', '') }}" step="1" required>
                @if($errors->has('wifi'))
                    <div class="invalid-feedback">
                        {{ $errors->first('wifi') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attitude') ? 'is-invalid' : '' }}" type="text" name="attitude" id="attitude" value="{{ old('attitude', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('noise') ? 'is-invalid' : '' }}" type="number" name="noise" id="noise" value="{{ old('noise', '') }}" step="1" required>
                @if($errors->has('noise'))
                    <div class="invalid-feedback">
                        {{ $errors->first('noise') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quietness') ? 'is-invalid' : '' }}" type="number" name="quietness" id="quietness" value="{{ old('quietness', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('star') ? 'is-invalid' : '' }}" type="number" name="star" id="star" value="{{ old('star', '') }}" step="1">
                @if($errors->has('star'))
                    <div class="invalid-feedback">
                        {{ $errors->first('star') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_score') ? 'is-invalid' : '' }}" type="number" name="total_score" id="total_score" value="{{ old('total_score', '') }}" step="1" required>
